...
./xmlchange RESUBMIT=11,STOP_N=5
...
./xmlchange JOB_WALLCLOCK_TIME=05:30:00 --subgroup case.st_archive
...
./xmlchange STOP_N=5,RESUBMIT=10

./xmlchange STOP_N=5,RESUBMIT=11
